 ...
 */
/*
 * class Trader { private String name; private String city; }
 */
...
public class Assignment5Q4 {
	...
	public static int smallestTransaction1(List<Transaction> transactions) {
		...
		System.out.println("the transaction with the smallest value" + mn);
		return mn;

	}

	public static void main(String[] args) {
		Trader t1 = new Trader("Jagadeesh", "Bangalore");
		Trader t2 = new Trader("Lokesh", "Pune");
		Trader t3 = new Trader("Pavan", "Bangalore");
		Trader t4 = new Trader("Amrendra", "Delhi");
		Trader t5 = new Trader("Harshsri", "Chennai");

		Trader t6 = new Trader("Moonpie", "Pune");
		Trader t7 = new Trader("Sunpie", "Delhi");
		Trader t8 = new Trader("Earthpie", "Delhi");
		Trader t9 = new Trader("Kathik", "Pune");

		Transaction ts1 = new Transaction(t1, 2011, 800);
		Transaction ts2 = new Transaction(t2, 2011, 900);
		Transaction ts3 = new Transaction(t3, 2012, 250);
		Transaction ts4 = new Transaction(t4, 2011, 562);
		Transaction ts5 = new Transaction(t5, 2011, 753);
		Transaction ts6 = new Transaction(t6, 2010, 458);
		Transaction ts7 = new Transaction(t7, 2013, 963);
		Transaction ts8 = new Transaction(t8, 2012, 150);
		Transaction ts9 = new Transaction(t9, 2009, 005);
