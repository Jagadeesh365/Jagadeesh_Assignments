  ...
  let submitForm = async (event) => {
    ...
    try {
      ...
      if (response.data.message ==="Updated successfully!") {
       ...
       navigate("/manager/rooms/list", { replace: true });
      } 
      else {
        ...
        navigate(`/manager/updatetroom/${roomId}`, { replace: false });
      }
    } catch (error) {
      navigate(`/manager/updatetroom/${roomId}`, { replace: false });
    }
              ...
              <div className="mb-2">
                ...
                <div className="mb-2">
                  <input
                    ...
                    value="Craete"
                  />
                  <Link to={"/manager/rooms/list"} className="btn btn-dark ms-2">
                    {" "}
                    Close
                  </Link>
                </div>
...
export default ManagerUpdateRoom;
