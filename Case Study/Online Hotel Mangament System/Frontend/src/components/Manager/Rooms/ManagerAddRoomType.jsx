...
const ManagerAddRoomType = () => {
  ...
  let submitForm = async (event) => {
    ...
    try {
      ...
      navigate("/manager/addroomtype", { replace: false });
    }
  };
  return (
    <React.Fragment>
              ...
              <form onSubmit={submitForm}>
                ...
                <div className="mb-2">
                  <input
                    ...
                    value="Craete"
                  />
                  <Link to={"/manager/roomsNav"} className="btn btn-dark ms-2">
                    Close
                  </Link>
...
export default ManagerAddRoomType
