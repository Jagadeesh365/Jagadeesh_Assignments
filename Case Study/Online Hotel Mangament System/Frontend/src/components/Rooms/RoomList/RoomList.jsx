    ...
    <section className="p-3 bg-light">
        <div className="container">
            <div className="row animated flipInX delay-1s">
                ...
                <Link to={"/rooms/add"} className="btn btn-primary ms-2">
                                ...
                                filterRooms.length > 0 && filterRooms.map(room=>{
                                     return(
                                         <tr key={room.id}>
                                             ...
                                             <td>{room.status}</td>
                                             <td>
                                              <Link to={`/receptionist/editroom/${room.id}`} className="btn btn-primary my-1">
                                              ...
                                              <td>
                                              <Link to={`/rooms/view/${room.id}`} className="btn btn-warning my-1">
